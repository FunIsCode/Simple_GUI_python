...
class Converter:
    def __init__(self):
        ...
        self.__left_frame = Frame(self.__window, width=600, height=400, bd=8, relief='raise')
        self.__left_frame.pack(side=LEFT)
        self.__right_frame = Frame(self.__window, width=200, height=400, bd=8, relief='raise')
